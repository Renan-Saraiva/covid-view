...
@Component({
  ...
  styleUrls: ['./country-pick.component.css']
})
export class CountryPickComponent implements OnInit {

  private chart: am4maps.MapChart;

  constructor(private zone: NgZone, private countriesServices: CountriesService) { }

  ngOnInit() {
    console.log(this.countriesServices.getCountryByInternationalName("Brazil"));
  }
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      chart = am4core.create("world-map", am4maps.MapChart);
      ...
      let mapData = [
        ...
        { "id":"BR", "name":"Brasil", "value":196655014, "color":chart.colors.getIndex(3) },
